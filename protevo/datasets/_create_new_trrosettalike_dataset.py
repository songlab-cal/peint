...
#Much of this from Mogwai: https://github.com/songlab-cal/mogwai/blob/a24d741c01753c4776f5fc0955b8b1e356e7aae5/mogwai/alignment.py
...
def make_a3m(input_file: str, database: str, keep_intermediates: bool = False, output_dir: Optional[str]=None) -> None:
    ...
    if output_dir is not None:
        output_file = Path(output_dir) / Path(input_file).with_suffix(".a3m").name
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_directory", type=str, help="Input Directory with fasta files")
    parser.add_argument("--database", type=str, help="Path to HHblits database")
    parser.add_argument("--output_directory", type=str, help="Output Directory to save a3m files")
    ...
    for file in tqdm(os.listdir(input_directory)):
        ...
        if os.path.exists(os.path.join(output_directory, file.replace('.txt', '.a3m'))):
            continue
