...
# Re-exported here so existing `from peint.vep._train_utils import load_esm_model`
# call sites (train_peint_vep, train_peint_vep_per_family, _vep_utils) keep working.
from peint.vep.encoders import load_esm_model  # noqa: F401
from peint.vep._config import EMBED_DIM
